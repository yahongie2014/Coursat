...
<link rel="stylesheet" href="{{asset('')}}css/Simple-Line-Icons-Webfont/simple-line-icons.css"/>
  ...
  <div class="temp-header">
        ...
        <div class="top-links">
          ...
          <div class="col-md-6 pull-right text-right">
            <ul class="top-right-list">
              ...
              <li class="last"><a href="{{url('auth/github')}}"><i class="fa fa-github"></i></a></li>
              <li class="last"><a href="{{url('auth/github')}}"><i class="fa fa-Windows"></i></a></li>

               @else
               <li class="dropdown">
               <a href="{{url('/profile.html', Auth::user()->id)}}" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false">
             <div class="round"><img style="border-top-left-radius: 20px;border-top-right-radius: 20px;border-bottom-left-radius: 20px;border-bottom-right-radius: 20px;" src="{{ Auth::user()->pic }}"/></div> Welcome {{ Auth::user()->name }} ! <span class="caret"></span>
               </a>
               <ul class="dropdown-menu" role="menu">
               <li><a href="{{url('/profile.html', Auth::user()->id)}}"><i class="fa fa-btn fa-sign-out"></i>Profile</a></li>
    ...
    <div class="header-section transparent style1 pin-style">
      <div class="container">
        <div class="mod-menu">
          <div class="row">
            <div class="col-sm-2"> <a href="{{URL('/')}}" title="" class="logo"> <img src="{{asset('')}}/images/logo.png" alt=""> </a> </div>
            <div class="col-sm-10">
              <div class="main-nav">
...
<script src="{{asset('')}}js/megamenu/js/onepage.js"></script> 
<!-- Magnific Popup --> 
...
<!-- Animations --> 
<script src="{{asset('')}}js/animations/animations.min.js" type="text/javascript"></script> 
<script src="{{asset('')}}js/animations/appear.min.js" type="text/javascript"></script> 
<!-- Scroll Up --> 
<script src="{{asset('')}}js/scrolltotop/totop.js" type="text/javascript"></script>
<script src="{{asset('')}}js/form/jquery.form.min.js"></script> 
</body>
</html>