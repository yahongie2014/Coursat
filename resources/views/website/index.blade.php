...
@section('content')
        ...
        <div class="col-md-10 col-md-offset-1 text-center animate-in" data-anim-type="zoom-in" data-anim-delay="100">
          <div class="display-t">
            <div class="display-tc">
              <h1>The Best Professional Coursat online For better World!</h1>
            ...
            <div class="item active">
              <div class="col-lg-4 col-md-4">
                <div class="cource-box"><a href="#"><img class="img-responsive" src="images/course-1.jpg" alt=""></a>
                  <div class="cource-text">
                    <h4><a href="{{URL('/single.html')}}">Photoshop - Web Deisgn</a> <span>EGP195</span></h4>
              ...
              <div class="col-lg-4 col-md-4">
                <div class="cource-box"><a href="#"><img class="img-responsive" src="images/course-2.jpg" alt=""></a>
                  <div class="cource-text">
                    <h4><a href="{{URL('/single.html')}}">Sketch - Mobile App</a> <span>EGP195</span></h4>
                    <p>Suspendisse ante mi iaculis ac eleifend id venenatis non eros. Sed rhoncus gravida eli eu sollicitudin.</p>
                    <a href="{{URL('/single.html')}}" class="btn btn-small">Read More</a> </div>
                </div>
              </div>
              <div class="col-lg-4 col-md-4">
                <div class="cource-box"><a href="#"><img class="img-responsive" src="images/course-3.jpg" alt=""></a>
                  <div class="cource-text">
                    <h4><a href="{{URL('/single.html')}}">CSE Engineering</a> <span>EGP195</span></h4>
                    <p>Suspendisse ante mi iaculis ac eleifend id venenatis non eros. Sed rhoncus gravida eli eu sollicitudin.</p>
                    <a href="{{URL('/single.html')}}" class="btn btn-small">Read More</a> </div>
                </div>
              </div>
  ...
  <div class="section-lg m-bottom10">
    ...
    <div class="container-fluid">
      <div class="col-md-4 col-sm-6 projects animate-in" data-anim-type="fade-in" data-anim-delay="100"><a href="#"><img src="images/project-1.jpg" alt="" class="img-responsive">
        <h3>Web Development</h3>
        <span>View Course</span> </a> </div>
      <div class="col-md-4 col-sm-6 projects animate-in" data-anim-type="fade-in" data-anim-delay="200"><a href="#"><img src="images/project-2.jpg" alt="" class="img-responsive">
        <h3>Virtual Assistant</h3>
        <span>View Course</span> </a> </div>
      <div class="col-md-4 col-sm-6 projects animate-in" data-anim-type="fade-in" data-anim-delay="300"><a href="#"><img src="images/project-3.jpg" alt="" class="img-responsive">
        <h3>Class Room</h3>
        <span>View Course</span> </a> </div>
      <div class="col-md-4 col-sm-6 projects animate-in" data-anim-type="fade-in" data-anim-delay="400"><a href="#"><img src="images/project-4.jpg" alt="" class="img-responsive">
        <h3>Web Programming</h3>
        <span>View Course</span> </a> </div>
      <div class="col-md-4 col-sm-6 projects animate-in" data-anim-type="fade-in" data-anim-delay="500"><a href="#"><img src="images/project-5.jpg" alt="" class="img-responsive">
        <h3>Art &amp; Photography</h3>
        <span>View Course</span> </a> </div>
      <div class="col-md-4 col-sm-6 projects animate-in" data-anim-type="fade-in" data-anim-delay="600"><a href="#"><img src="images/project-6.jpg" alt="" class="img-responsive">
  ...
  <div class="section-lg m-bottom10">
    <div class="container">
      <div class="col-md-8 col-md-push-5 animate-in" data-anim-type="fade-in-up" data-anim-delay="100"><img class="img-responsive" src="images/course-2.jpg" alt="course"></div>
      <div class="col-md-4 col-md-pull-8 animate-in" data-anim-type="fade-in-up" data-anim-delay="200">
        <div class="m-top6">
          <div class="fea-info">
    ...
    <div class="container">
      <div class="row">
        <div class="col-md-8 col-md-offset-2 sec-heading text-center">
          ...
          <p>Welcome To Our Web Team</p>
        </div>
      </div>
      <div class="row animate-box" style="border-bottom:0;">
        <div class="col-md-3 col-sm-3 text-center animate-in" data-anim-type="fade-in-up" data-anim-delay="100">
          <div class="staff"> <img src="images/trainer-1.jpg" alt="trainer" class="img-responsive">
            <h3>Mohamed</h3>
            <strong class="role">Web designer</strong> </div>
        </div>
        <div class="col-md-3 col-sm-3 text-center animate-in" data-anim-type="fade-in-up" data-anim-delay="200">
          <div class="staff"> <img src="images/trainer-2.jpg" alt="trainer" class="img-responsive">
            <h3>Shrouk</h3>
            <strong class="role">PHP Develoepr</strong> </div>
        </div>
        <div class="col-md-3 col-sm-3 text-center animate-in" data-anim-type="fade-in-up" data-anim-delay="300">
          <div class="staff"> <img src="images/trainer-2.jpg" alt="trainer" class="img-responsive">
            <h3>Eman</h3>
            <strong class="role">Web Designer</strong> </div>
        </div>
        <div class="col-md-3 col-sm-3 text-center animate-in" data-anim-type="fade-in-up" data-anim-delay="400">
          <div class="staff"> <img src="images/trainer-2.jpg" alt="trainer" class="img-responsive">
            <h3>Salsabel</h3>
            <strong class="role">Css Designer</strong> </div>
        </div>
      </div>
    </div>
  </div>
