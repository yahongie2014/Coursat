  ...
  <div class="page-header one">
    <div class="container">
      ...
      <div class="col-md-6 pull-right">
        <div class="breadcrumbs"><a href="<?php echo e(URL('/')); ?>">Home</a> <i>/</i> Courses List View</div>
      </div>
    </div>
  </div>
  <!-- end page header -->
          ...
          <div class="cource-box">
            <div class="row cource-text">
              ...
              <div class="col-lg-8 col-md-8">
                <div>
                  <h4><a href="<?php echo e(URL('/single.html')); ?>">Photoshop - Web Deisgn</a> <span>$195</span></h4>
                  <p>Suspendisse ante mi iaculis ac eleifend id venenatis non eros. Sed rhoncus gravida eli eu sollicitudin.</p>
                  <a href="<?php echo e(URL('/single.html')); ?>" class="btn btn-small">Read More</a> </div>
              </div>
            </div>
          </div>
        </div>
        <div class="col-lg-12 col-md-12">
          <div class="cource-box">
            <div class="row cource-text">
              ...
              <div class="col-lg-8 col-md-8">
                <div>
                  <h4><a href="<?php echo e(URL('/single.html')); ?>">Sketch - Mobile App</a> <span>$195</span></h4>
                  <p>Suspendisse ante mi iaculis ac eleifend id venenatis non eros. Sed rhoncus gravida eli eu sollicitudin.</p>
                  <a href="<?php echo e(URL('/single.html')); ?>" class="btn btn-small">Read More</a> </div>
              </div>
            </div>
        ...
        <div class="col-lg-12 col-md-12">
          <div class="cource-box">
            <div class="row cource-text">
              ...
              <div class="col-lg-8 col-md-8">
                <div>
                  <h4><a href="<?php echo e(URL('/single.html')); ?>">Software Training</a> <span>$195</span></h4>
                  <p>Suspendisse ante mi iaculis ac eleifend id venenatis non eros. Sed rhoncus gravida eli eu sollicitudin.</p>
                  <a href="<?php echo e(URL('/single.html')); ?>" class="btn btn-small">Read More</a> </div>
              </div>
            </div>
        ...
        <div class="col-lg-12 col-md-12">
          <div class="cource-box">
            <div class="row cource-text">
              ...
              <div class="col-lg-8 col-md-8">
                <div>
                  <h4><a href="<?php echo e(URL('/single.html')); ?>">Developing Mobile Apps</a> <span>$195</span></h4>
                  <p>Suspendisse ante mi iaculis ac eleifend id venenatis non eros. Sed rhoncus gravida eli eu sollicitudin.</p>
                  <a href="<?php echo e(URL('/single.html')); ?>" class="btn btn-small">Read More</a> </div>
              </div>
            </div>
        ...
        <div class="col-lg-12 col-md-12">
          <div class="cource-box">
            <div class="row cource-text">
              ...
              <div class="col-lg-8 col-md-8">
                <div>
                  <h4><a href="<?php echo e(URL('/single.html')); ?>">Starting a Startup</a> <span>$195</span></h4>
                  <p>Suspendisse ante mi iaculis ac eleifend id venenatis non eros. Sed rhoncus gravida eli eu sollicitudin.</p>
                  <a href="<?php echo e(URL('/single.html')); ?>" class="btn btn-small">Read More</a> </div>
              </div>
            </div>
        ...
        <div class="col-lg-12 col-md-12">
          <div class="cource-box">
            <div class="row cource-text">
              ...
              <div class="col-lg-8 col-md-8">
                <div>
                  <h4><a href="<?php echo e(URL('/single.html')); ?>">Basic of Nature Photography</a> <span>$195</span></h4>
                  <p>Suspendisse ante mi iaculis ac eleifend id venenatis non eros. Sed rhoncus gravida eli eu sollicitudin.</p>
                  <a href="<?php echo e(URL('/single.html')); ?>" class="btn btn-small">Read More</a> </div>
              </div>
            </div>
  ...
  <div class="bg-parallax">
    ...
    <div class="container">
      ...
      <div class="row animate-in" data-anim-type="fade-in-up" data-anim-delay="100">
        <div class="col-md-8 col-md-offset-2 text-center">
          <p><a href="<?php echo e(URL('/single.html')); ?>" class="btn btn-primary btn-lg">Create A Free Course</a></p>
        </div>
      </div>
    </div>
  </div>
